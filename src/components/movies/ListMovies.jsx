...
export const ListMovies = ({ poster_path, title, original_language, overview, id }) => {
    ...
    return (
        <>
            <div className="card col-12 col-sm-3 col-md-5 col-lg-2 my-2 p-0 animate__animated animate__fadeIn">
                <img src={rutaImg} alt={title} className='w-100 card-img-top' height='350px' />
                <div className="card-body text-center p-0 mt-2 d-flex flex-column align-items-center">
                    <h5 className="card-title mt-2 d-flex align-items-center justify-content-center h-50">{title}</h5>
